...
The original downloads are kept in the project root. The three files served by
the site are trimmed, normalized and locally encoded derivatives. They are not
requested from a third-party host at runtime.

All three sources are published on Pixabay under the Pixabay Content License:
